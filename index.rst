...
`security fixes <https://github.com/Shatathub/solidity/security/policy#supported-versions>`_.
...
* :ref:`The Shatat Virtual Machine <the-shatat-virtual-machine>`.
...
.. hint::
  ...
  `Remix IDE <https://remix.shatat.ir>`_.
