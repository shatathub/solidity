...
.. code-block:: solidity
    ...
    contract Purchase {
        ...
        /// Abort the purchase and reclaim the shatat.
        ...
        /// Transaction has to include `2 * value` shatat.
        /// The shatat will be locked until confirmReceived
        /// is called.
        ...
        /// This will release the locked shatat.
