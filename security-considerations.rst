...
Restrict the Amount of Shatat
============================

Restrict the amount of Shatat (or other tokens) that can be stored in a smart contract.
If your source code, the compiler or the platform has a bug, these funds may be lost.
If you want to limit your loss, limit the amount of Shatat.
...
(who called the function, are the arguments in range, did they send enough Shatat,
...
You can add a function in your smart contract that performs some self-checks like "Has any Shatat leaked?",
...
or just converts the contract into a simple "give me back my Shatat" contract.
